        ...
        $(function(){
            ...
            function sc_num(){
                ...
                if(cookieStr){
                    ...
                    $("#num").html("("+ sum +")").css("color","orange");
                }else{
                    $(".sc_right .sc_num").html(0);
                    $("#num").html("("+ 0 +")").css("color","orange");
                }
            }
            ...
            function ballMove(oBtn){
                ...
                var X = $(".sc_right .sc_pic").offset().left - $(oBtn).offset().left-35;
                var Y = $(".sc_right .sc_pic").offset().top - $(oBtn).offset().top-35;
